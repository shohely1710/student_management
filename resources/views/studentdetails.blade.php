...
<form action="<?=url('studentdetails2'); ?>" method="post">
    @csrf
...
<script type="text/javascript">
    $(document).ready(function(){
        function fetch_data(page, sort_type="", sort_by="", search=""){
            $.ajax({
                url:"<?php echo url(''); ?>/studentdetails-ajax?page="+page+"&sorttype="+sort_type+"
                  &sortby="+sort_by+"&search="+search,
        ...
        $(documet).on('keyup', '#student_search', function(){
