...
Route::get('single_student', [Studentcontrol::class, 'single_student'])->name('single.student');
Route::get('Fee-form', [Studentcontrol::class, 'fee_form'])->name('student.fee');
Route::post('fee-add',[Studentcontrol::class, 'feeadd']);
Route::post('studentdetails2', [Studentcontrol::class, 'show']);
